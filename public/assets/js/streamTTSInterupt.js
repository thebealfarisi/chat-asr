...
exports.interruptAudioStream = exports.createAudioStreamFromText = void 0;
...
var createAudioStreamFromText = function (text) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                interruptFlag = false; // Reset the interrupt flag at the beginning of each new audio generation
            ...
            case 4:
                ...
                chunk = _d;
                if (interruptFlag) {
                    console.log("Audio generation interrupted!");
                    return [3 /*break*/, 6];
                }
                chunks.push(chunk);
                _e.label = 5;
...
// Function to interrupt the audio stream
var interruptAudioStream = function () {
    interruptFlag = true;
};
exports.interruptAudioStream = interruptAudioStream;
// Example usage
// (async () => {
//   try {
//     const text = "Hello, this is a test of the ElevenLabs text-to-speech service.";
//     const audioBuffer = await createAudioStreamFromText(text);
//     // Write the buffer to a file or handle it as needed
